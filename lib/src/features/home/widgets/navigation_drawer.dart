      ...
      return ExpansionTile(
        ...
        children: List.generate(
          ...
          (subIndex) => Column(
            ...
            children: [
              InkWell(
                onTap:drawerIconList(context)[index]["children"][subIndex]["onTap"],
                child: Row(
                  children: [
                    Container(
                      width: 42,
                      ...
                      child:
                          ...
                          drawerIconList(context)[index]["children"][subIndex]["icons"],
                    ),
                    const SizedBox(width: 10),
                    Text(
                      // drawerIconList(context)[index]["children"][index]["title"],
                      // "index",
                      drawerIconList(context)[index]["children"][subIndex]["title"],
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w400,
                        color: AppColors.cFFFFFF,
              ...
              if (subIndex != 0 ||
                  subIndex != (drawerIconList(context)[index]["children"].length - 1))
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 11.0),
                  child: Divider(
                    color: AppColors.c9D9B9B,
